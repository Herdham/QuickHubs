jQuery(function () {
    ...
    const backward = document.querySelector("#scrollback");
    const forward = document.querySelector("#scrollforward");
    const carousel = document.querySelector(".carousel .carouselbody");
